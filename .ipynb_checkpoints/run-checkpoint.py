...
if __name__ == '__main__':
    ...
    parser.add_argument('-num_factors', dest="num_factors", default=10, type=int, help="Number of factors")
    parser.add_argument('-alpha', dest="alpha", default=1e-2, type=float, help='Dropout for Feature')
    parser.add_argument('-mi_train', dest='mi_train', action='store_true', help='whether to disentangle')
    parser.add_argument('-early_stop', dest="early_stop", default=25, type=int, help="number of early_stop")
    parser.add_argument('-no_params', dest='no_params', action='store_true', help='whether to add parameters')
    ...
    parser.add_argument('-mi_method', dest='mi_method', default='club', help='Composition Operation to be used in RAGAT')
    parser.add_argument('-att_mode', dest='att_mode', default='learn', help='Composition Operation to be used in RAGAT')
    parser.add_argument('-mi_epoch', dest="mi_epoch", default=1, type=int, help="Number of MI_Disc training times")
    parser.add_argument('-score_method', dest='score_method', default='cat_weight', help='Composition Operation to be used in RAGAT')
    parser.add_argument('-score_order', dest='score_order', default='before', help='Composition Operation to be used in RAGAT')
    ...
    parser.add_argument('-gamma_method', dest='gamma_method', default='fix', help='Composition Operation to be used in RAGAT')
